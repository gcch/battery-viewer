...
public class BatteryStatusAppWidget2x1Provider extends AppWidgetProvider {

    private static int layoutResId = R.layout.widget_2x1;
    ...
    public void onEnabled(Context context) {
        ...
        // サービス起動
        context.startService(new Intent(context.getApplicationContext(), BatteryStatusAppWidget2x1Provider.AppWidget2x1UpdateService.class));
    ...
    public void onDisabled(Context context) {
        ...
        status = false;
        context.stopService(new Intent(context.getApplicationContext(), BatteryStatusAppWidget2x1Provider.AppWidget2x1UpdateService.class));
...
//    }
    ...
    private synchronized static void updateAppWidget(Context context, RemoteViews rv) {
        ...
        ComponentName cn = new ComponentName(context, BatteryStatusAppWidget2x1Provider.class);
        AppWidgetManager awm = AppWidgetManager.getInstance(context);
        awm.updateAppWidget(cn, rv);
    }


    public static class AppWidget2x1UpdateService extends Service {

        final IWidget2x1AidlInterface.Stub binder = new IWidget2x1AidlInterface.Stub() { };

        public AppWidget2x1UpdateService() {
        }
        ...
        static void registerBroadcastReceiver(Context context) {
            if (mReceiver == null) {
                ...
                mReceiver = new AppWidget2x1BroadcastReceiver();
    ...
    public static class AppWidget2x1BroadcastReceiver extends BroadcastReceiver {
        @Override
        public void onReceive(Context context, Intent intent) {
